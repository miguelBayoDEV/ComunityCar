...
class __TwigTemplate_6bc2483634116f0614365778b5afe5f5cb98b6317d432e7ca7a72070abca7e1c extends Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["vehicle"]) {
            // line 25
            echo "        ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["vehicle"], "eliminado", [], "any", false, false, false, 25), false))) {
                // line 26
                ...
                <button><a href=\"";
                // line 31
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("message_new", ["receptor" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["vehicle"], "propietario", [], "any", false, false, false, 31), "id", [], "any", false, false, false, 31), "emisor" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
...
{% block body %}
    ...
    {% for vehicle in vehicles %}
        {% if vehicle.eliminado == false %}
            <div class=\"vehicles\">
                Marca: {{ vehicle.marca }}
                Modelo: {{ vehicle.modelo }}
                {{ vehicle.propietario.email }}
                {{ vehicle.fechaModificacion|date('Y-m-d H:i:s') }}
                <button><a href=\"{{ path('message_new', {'receptor': vehicle.propietario.id, 'emisor': user.id }) }}\">Enviar mensaje</a></button>
            </div>
        {% endif %}
    {% endfor %}
{% endblock %}
", "main/index.html.twig", "/home/bayo/proyectos/ComunityCar/templates/main/index.html.twig");
    }
}
