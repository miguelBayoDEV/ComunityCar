...
class __TwigTemplate_4f955a697ce1f855d6df04789d9d4a7a9f1ae518a459e4f8f0577a3cf1667ef1 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Mensajes reportados:</h1>
    ";
        // line 7
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            ...
            if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["message"], "reportado", [], "any", false, false, false, 8), true)) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["message"], "oculto", [], "any", false, false, false, 8), true)))) {
                ...
                echo " - Emisor: ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "user", [], "any", false, false, false, 9), "email", [], "any", false, false, false, 9), "html", null, true);
                echo " - ";
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "fechaEnvio", [], "any", false, false, false, 9), "Y-m-d"), "html", null, true);
                echo "
            <button><a href=\"/respuesta/";
                // line 10
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "id", [], "any", false, false, false, 10), "html", null, true);
    ...
    {
        return array (  113 => 13,  107 => 10,  98 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mensajes reportados{% endblock %}
